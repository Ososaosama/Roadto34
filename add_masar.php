...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insertQuery = $pdo->prepare("INSERT INTO custom_tours (user_id, start_date, end_date, people_count, category, notes, city_id, place_id, guideid) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $insertQuery->execute([$userId, $startDate, $endDate, $peopleCount, $category, $notes, $cityId, $placeId, $guideId]);
