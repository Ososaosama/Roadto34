...
<div class="container-xxl py-5">
    <div class="containerr">
        ...
        <div class="row g-8" style="background-color:#088e81;">
            <div class="col-lg-12 col-md-6 wow fadeInUp new" data-wow-delay="0.1s">
                <h3 class="ss" style="color:#000">تفاصيل المرشد السياحي</h3>
                <div class="team-item d-flex align-items-start style" style="background-color:#086f65;">
                    <!-- Image Section -->
                ...
                <?php 
                    if (!isset($_SESSION['userId'])) { 
                        ...
                        echo '<a href="../index.php?page=login" class="btn custom-masar-btn">طلب مسار خاص</a>';
                    } else {
                        // إذا كان المستخدم مسجل الدخول
                        echo '<a href="add_masar.php?userId=' . $_SESSION['userId'] . '&guideId=' . $_GET['guideId'] . '" class="btn custom-masar-btn">طلب مسار خاص</a>';
                    }
                    ?>
...
<style>
    ...
    .custom-masar-btn {
        ...
        background-color: #826D42; /* اللون الرمادي الداكن */
        color: #000 !important; /* لون النص الأسود */
        ...
        border: 2px solid #000; /* إضافة حدود سوداء */
        }
    /* تأثير التمرير */
    .custom-masar-btn:hover {
        background-color: #a88c53; /* لون أغمق عند تمرير الفأرة */
        color: #000; /* التأكد من أن النص يظل أبيض */
       ...
       <!-- Form for adding a new review -->
        ...
        <div class="mt-4" style="text-align: right;">
            <h4 style="color:#000;">إضافة تقييم وتعليق</h4>
            <form action="" method="POST">
                ...
                <button type="submit" name="submit_review" class="btn btn-primary mt-3" style="border: 2px solid #000;">إرسال</button>
            </form>
        </div>
    ...
    <h4 style="color:#000;">التعليقات والتقييمات</h4>
    <?php if ($reviews): ?>
        <?php 
