...
<div class="container">
  ...
  <form method="POST" enctype="multipart/form-data">
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="Name" name="Name" required style="background-color: #CCCCCC;">
    </div>
    
    <div class="mb-3">
      <label for="cityImage" class="form-label">صورة المدينة</label>
      <input type="file" class="form-control" id="CityImage" name="cityImage" accept="image/*" required style="background-color: #CCCCCC;">
    </div>
    <button type="submit" class="btn btn-primary custom-hover w-100" name="addCity">
    إضافة مدينة
</button>
  </form>
...
.btn-primary.custom-hover:hover {
  ...
  <?php if (!empty($cities)): ?>
    <table class="table table-bordered table-striped" style="background:#25978B;">
      <thead style="background-color: #032124;color:#FFF;">
        <tr>
          <th>ID</th>
          <th>Name</th>
          <th>Image</th>
