...
<div class="container">
    ...
    <?php if (!empty($guides)): ?>
        <table class="table table-bordered table-hover table-striped" style="background:#25978B;">
            <thead>
                <tr style="background-color: #032124;color:#FFF;">
                    <th>المعرف</th>
                    <th>الاسم</th>
                    <th>اللغات</th>
